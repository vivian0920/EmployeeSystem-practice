...
//功能: 擴充KendoDatePicker功能 - 日期區間IntervalDatePicker
//描述: 日期區間輸入
...
(function ($) {
    ...
    /**
     * @classdesc 日期區間IntervalDatePicker
     * @class BestIntervalDatePicker
     */
    var GssIntervalDatePicker = Widget.extend({
        ...
        options: {
             ...
             * @default BestIntervalDatePicker
             * @MemberOf BestIntervalDatePicker
             */
            name: "BestIntervalDatePicker",
             ...
             * @MemberOf BestIntervalDatePicker
             */
            is_tw_year: ControlDefaultsObject.IntervalDatePicker.is_tw_year || false,
             ...
             * @MemberOf BestIntervalDatePicker
             */
            date_delimiter: ControlDefaultsObject.IntervalDatePicker.date_delimiter || "/",
             ...
             * @MemberOf BestIntervalDatePicker             
             */
            allow_shortcut: ControlDefaultsObject.IntervalDatePicker.allow_shortcut || false,
             ...
             */
            shortcut_data_source: ControlDefaultsObject.IntervalDatePicker.shortcut_data_source || [],
             ...
             * @MemberOf BestIntervalDatePicker
             */
            format: ControlDefaultsObject.IntervalDatePicker.format || "yyyy/MM/dd",
             ...
             * @MemberOf BestIntervalDatePicker
             */
            suffix: ControlDefaultsObject.IntervalDatePicker.suffix || "",
             ...
             */
            required_mode: ControlDefaultsObject.IntervalDatePicker.required_mode || "N",
             ...
             */
            readonly_mode: ControlDefaultsObject.IntervalDatePicker.readonly_mode || "N",
             ...
             * @MemberOf BestIntervalDatePicker
             */
            min: ControlDefaultsObject.IntervalDatePicker.min || new Date(1900, 0, 1),
             ...
             * @MemberOf BestIntervalDatePicker
             */
            max: ControlDefaultsObject.IntervalDatePicker.max || new Date(2099, 11, 31),
             ...
             * @MemberOf BestIntervalDatePicker
             */
            diff_operator: ControlDefaultsObject.IntervalDatePicker.diff_operator || null,

            /**
             * @property {string} diff_unit 單位(D 日/M 月)
             * @default null
             * @MemberOf BestIntervalDatePicker
             */
            diff_unit: ControlDefaultsObject.IntervalDatePicker.diff_unit || null,
             ...
             * @MemberOf BestIntervalDatePicker
             */
            diff: ControlDefaultsObject.IntervalDatePicker.diff || null,
             ...
             * @MemberOf BestIntervalDatePicker
             */
            is_escape_confirm: ControlDefaultsObject.IntervalDatePicker.is_escapte_confirm || false,
             ...
             * @MemberOf BestIntervalDatePicker
             */
            is_change: ControlDefaultsObject.IntervalDatePicker.is_change || false,
         ...
         * 設值: element.BstartValue("20140724");
         */
        ...
        _create: function () {
            ...
            //Step3: 將日期區間控制項套用底層格式
            that.startInterval.kendoBestDatePicker({
            ...
            that.endInterval.kendoBestDatePicker({
                is_tw_year: that.options.is_tw_year,
                date_delimiter: that.options.date_delimiter,
                format: that.options.format,
                min: that.options.min,
        ...
        _quickClick: function (realDate) {
            ...
            if (realDate.length == 4) {
                ...
                startDate = StringFormatObject.DateTime.FormatDate(realDate + "0101", that.options.format, false);

                if (that.options.diff_unit !== null) {
                    endDate = StringFormatObject.DateTime.FormatDate(that._diffdate(realDate + "0101", that.options.diff_unit, that.options.diff), that.options.format, false);
                }
                else {
                    endDate = StringFormatObject.DateTime.FormatDate(realDate + "1231", that.options.format, false);
                }
            }
                ...
                if (that.options.diff_unit !== null) {
                    endDate = StringFormatObject.DateTime.FormatDate(that._diffdate(realDate + "01", that.options.diff_unit, that.options.diff), that.options.format, false);
                }
                else {
            ...
            else if (realDate.length == 8) {
                //表示快速查詢為年月日格式

                startDate = StringFormatObject.DateTime.FormatDate(realDate, that.options.format, false);

                if (that.options.diff_unit !== null) {
                    endDate = StringFormatObject.DateTime.FormatDate(that._diffdate(realDate, that.options.diff_unit, that.options.diff), that.options.format, false);
                }
                else {
                    endDate = StringFormatObject.DateTime.FormatDate(realDate, that.options.format, false);
                }
            }
        ...
        _diffdate: function (date, diff_unit, diff) {
            var that = this,
                startDate = "",
                startInterval = that.startInterval.data("kendo" + that.options.childName);

            startDate = StringFormatObject.DateTime.FormatDate(date, that.options.format, false);
            var dateObj = startInterval._splitDate(startDate, that.options.format);

            startDate = new Date(dateObj.yyyy + "/" + dateObj.MM + "/" + dateObj.dd);
    ...
    ui.plugin(GssIntervalDatePicker);
