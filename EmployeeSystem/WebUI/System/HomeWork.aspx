...
<body>
    ...
    <div >
             <div id="input" style="margin-left:100px;">
                ...
                <div>
                    ...
                    <input type="text" id="employeeName" data-role="besttextbox" data-placeholder="請輸入" />
                </div>
                 <div>
                    <label style="float:left;margin-right:50px">請輸入員編:</label>
                    <input type="text" id="employeeId" data-role="besttextbox"data-mode="AlphaNumeric" data-placeholder="請輸入"/>
                </div>
                 <div style="margin-bottom:10px">
                    <label style="float:left; margin-left:15px ;margin-right:50px">到職日期:</label>
                    <input type="text" id="hireDate"  data-role="bestdatepicker" data-is_tw_year="true"/>
                </div>
            </div>
    </div>
    <div id="buttons" style="margin-left:100px" >
                    ...
                    <button class="btn btn-light" id="searchButton">查詢</button>
